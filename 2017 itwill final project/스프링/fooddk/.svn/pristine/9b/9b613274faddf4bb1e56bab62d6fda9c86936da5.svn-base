...
public class PageCounter_hoogi{	
	public static ListResultBean_hoogi getPagingInfo(	int selectPage,
												int rowCountPerPage,
												int pageCountPerPage, 
												int totalRecordCount)throws Exception{
		ListResultBean_hoogi resultBean = new ListResultBean_hoogi();
	  ...
	  public static void main(String[] args) throws Exception{
		  ...
		  ListResultBean_hoogi resultBean = PageCounter_hoogi.getPagingInfo(selectPage,rowCountPerPage,pageCountPerPage,totalRecordCount);
		  System.out.println("***************����������***************");
			System.out.println("01.selectPage:\t\t\t"+resultBean.getSelectPageNo());
			System.out.println("02.rowCountPerPage:\t\t"+rowCountPerPage);
			System.out.println("03.pageCountPerPage:\t\t"+pageCountPerPage);
