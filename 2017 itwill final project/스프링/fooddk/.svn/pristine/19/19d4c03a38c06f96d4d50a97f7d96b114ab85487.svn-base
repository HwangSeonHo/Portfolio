...
public class PageCounter_filter{	
	public static ListResultBean_filter getPagingInfo(	int selectPage,
												int rowCountPerPage,
												int pageCountPerPage, 
												int totalRecordCount,
												String d_filter,
												int d_groupno)throws Exception{
		...
		resultBean.setD_filter(d_filter);
		resultBean.setD_groupno(d_groupno);
		...
		System.out.println("15.filter:\t\t\t"+resultBean.getD_filter()); 		
		System.out.println("16.d_groupno:\t\t\t"+resultBean.getD_groupno()); 		
		System.out.println("**************************************");
		return resultBean;				
	}
	  ...
	  public static void main(String[] args) throws Exception{
		  ...
		  String d_filter="hoogi";
		  int d_groupno = 85;
		  ListResultBean_filter resultBean = PageCounter_filter.getPagingInfo(selectPage,rowCountPerPage,pageCountPerPage,totalRecordCount,d_filter,d_groupno);
		  System.out.println("***************����������***************");
			System.out.println("01.selectPage:\t\t\t"+resultBean.getSelectPageNo());
			System.out.println("02.rowCountPerPage:\t\t"+rowCountPerPage);
			System.out.println("03.pageCountPerPage:\t\t"+pageCountPerPage);
