...
public class PageCounter_recipe{	
	public static ListResultBean_recipe getPagingInfo(	int selectPage,
												int rowCountPerPage,
												int pageCountPerPage, 
												int totalRecordCount,
												int c_no)throws Exception{
		...
		System.out.println("15.getC_no:\t\t\t"+resultBean.getC_no()); 		
		System.out.println("**************************************");
		return resultBean;				
	}
	  ...
	  public static void main(String[] args) throws Exception{
		 ...
		 int c_no= 1;
		  ListResultBean_recipe resultBean = PageCounter_recipe.getPagingInfo(selectPage,rowCountPerPage,pageCountPerPage,totalRecordCount,c_no);
		  System.out.println("***************����������***************");
			System.out.println("01.selectPage:\t\t\t"+resultBean.getSelectPageNo());
			System.out.println("02.rowCountPerPage:\t\t"+rowCountPerPage);
			System.out.println("03.pageCountPerPage:\t\t"+pageCountPerPage);
			...
			System.out.println("13.isShowFirst:\t\t\t"+resultBean.isShowFirst());
			System.out.println("14.isShowLast:\t\t\t"+resultBean.isShowLast()); 		
			System.out.println("15.filter:\t\t\t"+resultBean.getC_no()); 		
			System.out.println("**************************************");
	}
