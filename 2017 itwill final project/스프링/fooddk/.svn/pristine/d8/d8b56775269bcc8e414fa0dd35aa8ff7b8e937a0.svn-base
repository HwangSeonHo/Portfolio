...
<script type="text/javascript">
	function Faq_Modify_Action(){
		...
		if(z.f_content.value ==""){
			alert("내용을 입력해주세요");
			z.f_content.focus();
			return false;			
		}
		 
		document.z.action="Faq_Modify_Action";
		document.z.method="post";
		document.z.submit();
	}
	
	function Faq_Remove_Action() {

		if (window.confirm("방명록을 삭제하시겠습니까?"))

			document.z.action = "Faq_Remove_Action";
		document.z.method = "post";
		document.z.submit();
...
<body>
											...
											<div id="respond" class="comment-respond">
												...
												<form name="z" method="post" id="commentform"
													...
													<div class="row commentrow comment-form-comment">
														<div class="row">
															<input type="hidden" name=f_no value="${faq.f_no}">															
															<div class="col-md-4 comment-form-author">
																...
																<input id="f_title" name="f_title" type="text" value="${faq.f_title}"> <br>
															</div>
 ...
 -->
														...
														<div class="col-md-12">
															...
															<textarea wrap="soft"  id="f_content" name="f_content" >${faq.f_content}</textarea>
														</div>
														<%-- <input
													...
													<div>
														<input type = "button" onClick="Faq_Modify_Action();" value ="Modify">
														<input type="button" onClick="Faq_Remove_Action();" rel="tag" value="delete">
														<input type = "button" onClick="Faq_List();" value ="List">
													</div>
