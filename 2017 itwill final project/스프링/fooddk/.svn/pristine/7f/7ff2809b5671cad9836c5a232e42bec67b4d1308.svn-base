...
<div id="wrapall">
    ...
    ==========================================-->
			...
			<div class="headercontent">
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							<h1>Contact</h1>
						    <span class="wtnbreadcrumbs"><a href="index.jsp">Home</a> <span class="separator">��</span> <span class="actual">Contact</span></span>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="container container-boxed">
			...
			<!-- START MAP CODE-->
			<script src='https://maps.googleapis.com/maps/api/js?v=3.exp'></script><div style='overflow:hidden;height:340px;width:100%;'><div id='gmap_canvas' style='height:340px;width:100%;'></div><div><small><a href="http://www.googlemapsgenerator.com/en/">Quickly generate and embed a Google Map on your site!									Click here									Visit our website</a></small></div><div><small><a href="https://www.promocode.com.ph/">Try this up-to-date vouchers!</a></small></div><style>#gmap_canvas img{max-width:none!important;background:none!important}</style></div><script type='text/javascript'>function init_map(){var myOptions = {zoom:10,center:new google.maps.LatLng(48.8697048,2.3079155000000355),mapTypeId: google.maps.MapTypeId.ROADMAP};map = new google.maps.Map(document.getElementById('gmap_canvas'), myOptions);marker = new google.maps.Marker({map: map,position: new google.maps.LatLng(48.8697048,2.3079155000000355)});infowindow = new google.maps.InfoWindow({content:'<strong>Our Location</strong><br>Champs Elysees, France<br>'});google.maps.event.addListener(marker, 'click', function(){infowindow.open(map,marker);});infowindow.open(map,marker);}google.maps.event.addDomListener(window, 'load', init_map);</script>
			<!-- END MAP CODE-->
			...
			<form method="post" action="contact.php" id="contactform">
				<div class="form">
					...
					<input type="submit" id="submit" class="clearfix btn btn-small" value="Send Message">
	...
	<script type='text/javascript' src='assets/js/validate.js'></script><!-- validate.js is for contact -->
	<!-- end scripts -->
</div>
<!-- end /.wrapall -->
</body>
