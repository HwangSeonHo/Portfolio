...
public class ListResultBean_tasty {
	private List<Tasty> list; 		// 리스트 데이터 콜렉션
	...
	public ListResultBean_tasty() {
	}

	public ListResultBean_tasty(List<Tasty> list, int startPageNo, int endPageNo,
	...
	public List<Tasty> getList() {
		return list;
	}

	public void setList(List<Tasty> list) {
		this.list = list;
	}
