...
<div id="wrapall">
    ...
    ==========================================-->
				...
				<div class="container">
					<div class="row">
						<div class="col-md-12">
						    ...
						    <span class="wtnbreadcrumbs"><a href="index.jsp">Home</a> <span class="separator">��</span> <span class="actual">Privacy Policy</span></span>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="container container-boxed">
			<h4>Show your visitors a privacy policy</h4>
			<hr>
			<p><strong>Our website takes privacy seriously</strong>. </p>
			<p>The following principles underpin our approach to respecting your privacy.</p>
			<p>We value the trust that you place in us by giving us your personal information. We will always use your personal information in a way that is fair and worthy of that trust.</p>
			<p><strong>We will provide clear information</strong> </p>
			<p>About how we use your personal information. We shall always be transparent with you about what information we collect, what we do with it, with whom we share it and who you should contact if you have any concerns.</p>
			<p><strong>We protect your information from misuse and keep it secure</strong></p>
			<p>We will comply with all applicable data protection laws and regulations and we will co-operate with data protection authorities. In the absence of data protection legislation, we will act in accordance with generally accepted principles governing data protection.</p>
			<p><strong>What we collect</strong></p>
			<p>We will only collect, use or disclose your personal information where it is fair and lawful to do so. In most cases, we will ask for your consent explicitly but, in some cases, we may infer consent from your actions and behaviour. We may ask you to provide additional consent if we need to use your personal information for purposes not covered by this Privacy Notice. You are not obliged to provide such consent but if you decide not to then your participation in certain activities may be restricted. If you provide additional consent, the terms of that consent shall prevail in the event of any conflict with the terms of this Privacy Notice.</p>
			<p><strong>Privacy Policy Changes</strong></p>
			<p>We reserve the right to change our privacy policy. Any change will be written on this pages. If you have questions, please, <a href="contact.jsp">contact us</a>.</p>
		</div>
		<!-- / END CONTAINER
		==========================================-->
	</div>
