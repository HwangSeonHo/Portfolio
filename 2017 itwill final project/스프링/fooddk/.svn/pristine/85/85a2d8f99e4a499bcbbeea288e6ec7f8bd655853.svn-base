...
<div id="wrapall">
    ...
    ==========================================-->
		...
		<div class="headertitle">
			<div class="headercontent">
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							<h1>Columns & Buttons</h1>
						    <span class="wtnbreadcrumbs"><a href="index.jsp">Home</a> <span class="separator">��</span> <span class="actual">Columns & Buttons</span></span>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="container container-boxed">
			...
			<h4>Lambada's columns and buttons</h4>
			<hr></div>
			<p>
				<a href="#" class="wbutton red size-small shadow-no radius-strong">Button</a>
				<a href="#" class="wbutton green size-small shadow-no radius-strong">Button</a>
				<a href="#" class="wbutton blue size-small shadow-no radius-strong">Button</a>
				<a href="#" class="wbutton purple size-small shadow-no radius-strong">Button</a>
				<a href="#" class="wbutton yellow size-small shadow-no radius-strong">Button</a>
			</p>
			<p>&nbsp;</p>
			<div class="col-md-6 col-md-offset-">Numerous years in the past, the rate of a topic was an awesome indicator of its first-class. Free subject matters have been often poorly coded at exceptional, and have been used to seize touchy person data at worst. but instances have modified, and builders in the WordPress network have created lots of high-quality free issues</div>
			<div class="col-md-6 col-md-offset-">Numerous years in the past, the rate of a topic was an awesome indicator of its first-class. Free subject matters have been often poorly coded at exceptional, and have been used to seize touchy person data at worst. but instances have modified, and builders in the WordPress network have created lots of high-quality free issues</div>
			<p>&nbsp;</p>
			<div class="col-md-4 col-md-offset-">Numerous years in the past, the rate of a topic was an awesome indicator of its first-class. Free subject matters have been often poorly coded at exceptional, and have been used to seize touchy person data at worst. but instances have modified.</div>
			<div class="col-md-4 col-md-offset-">Numerous years in the past, the rate of a topic was an awesome indicator of its first-class. Free subject matters have been often poorly coded at exceptional, and have been used to seize touchy person data at worst. but instances have modified.</div>
			<div class="col-md-4 col-md-offset-">Numerous years in the past, the rate of a topic was an awesome indicator of its first-class. Free subject matters have been often poorly coded at exceptional, and have been used to seize touchy person data at worst. but instances have modified.</div>
			<p>&nbsp;</p>
			<div class="col-md-8 col-md-offset-">Numerous years in the past, the rate of a topic was an awesome indicator of its first-class. Free subject matters have been often poorly coded at exceptional, and have been used to seize touchy person data at worst. but instances have modified, and builders in the WordPress network have created lots of high-quality free issues</div>
			<div class="col-md-4 col-md-offset-">Numerous years in the past, the rate of a topic was an awesome indicator of its first-class. Free subject matters have been often poorly coded at exceptional.</div>
			<p>&nbsp;</p>
			<div class="col-md-3 col-md-offset-">Numerous years in the past, the rate of a topic was an awesome indicator of its first-class.</div>
			<div class="col-md-3 col-md-offset-">Numerous years in the past, the rate of a topic was an awesome indicator of its first-class.</div>
			<div class="col-md-3 col-md-offset-">Numerous years in the past, the rate of a topic was an awesome indicator of its first-class.</div>
			<div class="col-md-3 col-md-offset-">Numerous years in the past, the rate of a topic was an awesome indicator of its first-class.</div>
			</div><!-- .entry-content -->
