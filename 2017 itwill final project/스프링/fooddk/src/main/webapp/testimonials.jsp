...
<div id="wrapall">
    ...
    ==========================================-->
			...
			<div class="headercontent">
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							<h1>Testimonials</h1>
						    <span class="wtnbreadcrumbs"><a href="index.jsp">Home</a> <span class="separator">��</span> <span class="actual">Testimonials</span></span>
						</div>
					</div>
				</div>
			</div>
		...
		<blockquote>
		<p>Thank you for the prompt payment and a smooth transaction. Overall, fantastic! I��d recommend them to anyone looking for a creative, thoughtful, and professional team. <cite>Lara Craft �� Product User</cite></p>
		</blockquote>
		<blockquote>
		<p>These are just some fake reviwes to showcase how your buyers testimonials would look on this page. We are a community project! If you find errors, incorrect data or have something you��d like to contribute, please contact. <cite>Smith Mary �� Loyal Customer</cite></p>
		</blockquote>
		<blockquote>
		<p>Overall, fantastic! I��d recommend them to anyone looking for a creative, thoughtful, and professional team. <cite>Donnie Brasco �� Subscriber</cite></p>
		</blockquote>
		<blockquote>
		<p>We are a community project! If you find errors, incorrect data or have something you��d like to contribute, please contact. <cite>Mike Anderson �� Loyal Customer</cite></p>
		</blockquote>
		<p><a href="contact.jsp" class="wbutton black size-small shadow-no radius-strong">Leave your review</a></p>
		</div>
		<!-- / END CONTAINER
		==========================================-->
	</div>
