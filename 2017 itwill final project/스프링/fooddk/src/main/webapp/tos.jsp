...
<div id="wrapall">
    ...
    ==========================================-->
			...
			<div class="headercontent">
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							<h1>Terms of Use</h1>
						    <span class="wtnbreadcrumbs"><a href="index.jsp">Home</a> <span class="separator">��</span> <span class="actual">Terms of Use</span></span>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="container container-boxed">
			<h4>Show terms of use to your visitors</h4>
			<hr>
			<p>Please read these Terms of Service (��Terms��, ��Terms of Service��) carefully before using the products created by our company (��us��, ��we��, or ��our��).</p>
			...
			<p>If you have any questions about these Terms, please <a href="contact.jsp">contact us</a>.</p>
		</div>
		<!-- / END CONTAINER
		==========================================-->
	</div>
