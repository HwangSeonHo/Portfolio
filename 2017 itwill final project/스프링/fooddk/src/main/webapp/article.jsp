				...
				<div class="col-md-8">
					<div id="primary" class="content-area">
							...
							<div class="contenttext">
								<div class="post-content">
									...
									<div class="wowmetaposts entry-meta">
										<span class="wowmetadate"><i class="fa fa-clock-o"></i> 3/02/2018</span>
										<span class="wowmetaauthor"><i class="fa fa-user"></i> <a href="#">Nat</a></span>
										<span class="wowmetacats"><i class="fa fa-folder-open"></i>	<a href="#">Business</a> , <a href="#">Marketing</a> , <a href="#">News</a> , <a href="#">Psychology</a></span>
										<span class="wowmetacommentnumber"><i class="fa fa-comments"></i> <a href="#">Leave a Comment</a></span>
									</div>
									<!-- .wowmetaposts -->
									<h4>Spend time with your family</h4>
									<p>
									...
									<p>
										<img class="aligncenter" src="assets/img/demo/b4.jpg" alt="">
									</p>
									<p>
									...
									<div class="tagcloud">
										<a href="#" rel="tag">advertise</a>
										<a href="#" rel="tag">business</a>
										<a href="#" rel="tag">redxun</a>
									</div>
								</div>
								<div class="clearfix">
								</div>
						...
						<div class="clearfix">
						 ...
						 짬 <a href="#" rel="prev">Create a monetized blog</a> &nbsp; &nbsp; <a href="#" rel="next">Live, Love &amp; Hope</a> 쨩
						<div class="clearfix">
						</div>
