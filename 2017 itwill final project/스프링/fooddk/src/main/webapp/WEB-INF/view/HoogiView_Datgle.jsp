...
<script type="text/javascript">
	...
	function HoogiRemove() {
		...
		if (window.confirm("��占쏙옙紐����β�쎌�������� ��������������������������占썲������占싼������몌옙��占�?"))
...
<body>
	<div id="wrapall">
		...
		==========================================-->
									...
									<div class="contenttext">
										<div class="post-content">
											...
											<div class="wowmetaposts entry-meta">
												...
												<!-- a href ������占쏙옙占쏙옙占쏙옙 ������������ ����������占쏙옙��占� ���э옙�쎌��占쎌�몄���ル���� -->
			...
			<div class="clearfix"></div>
			癲ワ옙���뀐옙占썲��占� <a href="#" rel="prev">Create a monetized blog</a> &nbsp;
			&nbsp; <a href="#" rel="next">Live, Love &amp; Hope</a> ��占쏙�占쏙옙占�
			<div class="clearfix"></div>
	...
	<div class="sectioncredits">
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					<span class="credits-left fleft"> 2017 癲ワ옙���뀐옙占썲��占� All Rights
