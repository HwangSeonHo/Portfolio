...
public class TastyModifyController {
	...
	public @ResponseBody int a_TastyUpdate(@RequestParam(value="uploadedfile" , required=false)  MultipartFile file, HttpServletRequest req, @ModelAttribute Tasty tasty){
