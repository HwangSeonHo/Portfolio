...
public class ListResultBean_hoogi {
	private List<Hoogi> list; 		// 리스트 데이터 콜렉션
	...
	public ListResultBean_hoogi() {
	}

	public ListResultBean_hoogi(List<Hoogi> list, int startPageNo, int endPageNo,
	...
	public List<Hoogi> getList() {
		return list;
	}

	public void setList(List<Hoogi> list) {
		this.list = list;
	}
