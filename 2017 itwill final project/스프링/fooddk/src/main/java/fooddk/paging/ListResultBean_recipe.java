...
public class ListResultBean_recipe {
	...
	public ListResultBean_recipe() {
	}

	public ListResultBean_recipe(List<Recipe> list, int startPageNo, int endPageNo,
			...
			int startRowNum, int endRowNum , int c_no) {
		this.list = list;
